...
require_once __DIR__. '/../components/green-alert.php';

red_alert('emptyInput');
green_alert('success');
...
<!-- form -->
    <form action="../process/register.php" method="POST" class="mt-20 mx-auto max-w-md space-y-4 rounded-lg border border-gray-300 bg-gray-100 p-6">
    <div>
    ...
    <a href="login.php" class="text-medium text-indigo-500 underline">Login disini</a>

    <button class="mt-5 block w-full rounded-lg border border-indigo-600 bg-indigo-600 px-12 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-indigo-600" type="submit" name="register">
        Register
    </button>
    </form>
